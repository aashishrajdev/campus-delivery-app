  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-primary text-primary-foreground p-4 sticky top-0 z-10 shadow-md">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="relative">
            <ShoppingCart className={`w-6 h-6 ${totalItems > 0 ? "animate-pulse" : ""}`} />
            {totalItems > 0 && (
      ...
      <div className="bg-gradient-to-r from-accent/20 to-primary/20 border border-border m-4 rounded-xl p-6 text-center shadow-sm">
        <p className="text-sm font-medium">Special Offer: Free delivery on orders above ₹100</p>
      </div>
      ...
      <div className="px-4 pb-24 space-y-3">
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-xs text-muted-foreground">{deliveryItems.length} items</span>
        </div>
      ...
      {totalItems > 0 && (
        <div className="fixed bottom-20 left-0 right-0 p-4 animate-in slide-in-from-bottom-4">
          <Button className="w-full bg-accent hover:bg-accent/90 text-accent-foreground py-6 rounded-xl shadow-lg font-bold text-lg flex items-center justify-between hover:scale-[1.02] transition-all active:scale-95">
